...
///        returns the number of observed corners
        unsigned int GridCalibrationTargetObservation::getCornerReprojection(
                const boost::shared_ptr <CameraGeometryBase> cameraGeometry,
            ...
            SM_ASSERT_TRUE(Exception, _T_t_c_isSet,
                           "Extrinsics not set. Reprojection can only be calculated if the extrinsics have been calculated. Use findTarget()...");
