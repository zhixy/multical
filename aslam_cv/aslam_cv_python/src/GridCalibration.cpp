...
void addImageToList(aslam::python::PythonImageList *list, const image_t &from) {
    list->addImage(from);
}
...
void exportGridCalibration() {
    ...
    class_<aslam::python::PythonImageList>("NumpyImageList", init<>())
    ...
    class_ < GridDetector, boost::shared_ptr < GridDetector >, boost::noncopyable > (
            "GridDetector",
                    init < boost::shared_ptr < CameraGeometryBase >, GridCalibrationTargetBase::Ptr,
                    GridDetector::GridDetectorOptions >
                    ("GridDetector::GridDetector( boost::shared_ptr<CameraGeometryBase> geometry, GridCalibrationTargetBase::Ptr target, GridDetector::GridDetectorOptions options)"))
    ...
    class_<GridCalibrationTargetCheckerboard::CheckerboardOptions>("CheckerboardOptions", init<>())
            ...
            .def_readwrite("performFastCheck",
                           &GridCalibrationTargetCheckerboard::CheckerboardOptions::performFastCheck)
    ...
    class_ < GridCalibrationTargetCheckerboard, bases < GridCalibrationTargetBase >,
            ...
            .def(init<size_t, size_t, double, double>(
                    "GridCalibrationTargetCheckerboard(size_t rows, size_t cols, double rowSpacingMeters, double colSpacingMeters)"))
            .def(init<>("Do not use the default constructor. It is only necessary for the pickle interface"))
    ...
    class_<GridCalibrationTargetCirclegrid::CirclegridOptions>("CirclegridOptions", init<>())
            ...
            .def_readwrite("showExtractionVideo",
                           &GridCalibrationTargetCirclegrid::CirclegridOptions::showExtractionVideo)
    ...
    GridCalibrationTargetBase::Ptr(GridCalibrationTargetObservation::*
    target)() = &GridCalibrationTargetObservation::target;

    class_ < GridCalibrationTargetObservation,
            boost::shared_ptr < GridCalibrationTargetObservation > > (
                    "GridCalibrationTargetObservation",
                            init<GridCalibrationTargetBase::Ptr>(
                                    "GridCalibrationTargetObservation(GridCalibrationTarget::Ptr target)"))
                    ...
                    .def("setTargetId", &GridCalibrationTargetObservation::setTargetId)
